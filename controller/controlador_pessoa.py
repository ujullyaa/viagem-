...
class ControladorPessoa:
        ...
        try:
            ...
            if self.pega_pessoa_por_cpf(cpf_limpo):
                raise ElementoRepetidoException(
                    f"Já existe uma pessoa com o CPF {cpf_limpo}")
            ...
            pessoa = Pessoa(dados["nome"], res_idade,
                            cpf_limpo, dados["telefone"])
    ...
    def alterar_pessoa(self):
        try:
            ...
            cpf_selecionado = self.__tela_pessoa.seleciona_pessoa_por_lista(
                dados_pessoas)
            ...
            valido_idade, res_idade = self.__validar_idade(
                novos_dados["idade"])
            if not valido_idade:
                return
