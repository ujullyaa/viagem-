...
class ControladorEmpresaTransporte():
    ...
    def alterar_empresa(self):
        ...
        if (empresa is not None):
            ...
            self.__tela_empresa_transporte.mostra_mensagem(
                "ATENCAO: Empresa não existente")
    ...
    def abre_tela(self):
        lista_opcoes = {1: self.incluir_amigo, 2: self.lista_amigos,
                        3: self.excluir_amigo, 0: self.retornar}
