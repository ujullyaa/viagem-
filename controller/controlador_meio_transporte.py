...
class ControladorMeioTransporte:
    ...
    def incluir_meio_transporte(self):
        ...
        meio = MeioTransporte(dados_meio_transporte["tipo"], dados_meio_transporte["capacidade"], dados_meio_transporte["empresa"])
    ...
    def excluir_meio_transporte(self):
        ...
        if(tipo is not None):
            ...
            self.__tela_meio_transporte.mostra_mensagem("ATENCAO: Meio de Transporte não existente")
    ...
    def alterar_meio_transporte(self):
        ...
        if meio:
            ...
            self.__tela_meio_transporte.mostra_mensagem(" Meio de transporte atualizado com sucesso!")
        else:
            self.__tela_meio_transporte.mostra_mensagem(" Meio de transporte não encontrado.")
